/* NRF24L01.c License Information:
 *
 ...
 */
/**TODO:
 * 	----: Figure out what radio info is needed for R/Tx operations
 * 	----: Make appropriate comments to help anyone understand how this driver works.
 */

// include custom transceiver library and SPI library for the STM-F4 series
#include "NRF24L01.h"
#include "stm32f4xx_hal.h"

// Set up the SPI handler.
// My config (see config file) uses the 3rd spi controller. Thus, SPI3
